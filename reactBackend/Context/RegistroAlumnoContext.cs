...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ANDERCISNEROS\\SQLEXPRESS; Initial Catalog=registroAlumno;User ID=Cisneros;Password = juve11; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FA75B0241");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F6410D858");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F34F788AB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F88D1AE6E");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7A299567B");
